...
def inference(images):
  ...
  layer1 = create_conv_layer(images, 3, 64, [5, 5], [3, 3], conv1_w_bits, conv1_w_max, conv1_b_bits,
                             conv1_b_max, conv1_a_bits, conv1_a_max, noise_stddev, layer_name='conv1')
  layer2 = create_conv_layer(layer1, 64, 64, [5, 5], [3, 3], conv2_w_bits, conv2_w_max, conv2_b_bits, conv2_b_max,
                             conv2_a_bits, conv2_a_max, noise_stddev, layer_name='conv2')


  with tf.name_scope('flatten'):
    x_flattened = tf.reshape(layer2, [FLAGS.batch_size, -1])

  hidden1 = create_fc_layer(x_flattened, x_flattened.get_shape()[1].value, 384, fc1_w_bits, fc1_w_max, fc1_b_bits, fc1_b_max, fc1_a_bits, fc1_a_max, noise_stddev, 'fully_connected1')
